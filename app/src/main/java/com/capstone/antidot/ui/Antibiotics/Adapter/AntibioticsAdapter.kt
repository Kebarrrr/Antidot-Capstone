...
class AntibioticsAdapter(private val context : Context, private val onItemClick: (AntibioticsItem) -> Unit) :
    ListAdapter<AntibioticsItem, AntibioticsAdapter.MyViewHolder>(DIFF_CALLBACK) {
